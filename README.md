<h6 align="center">Hi 👋, B.Tech.(IT) in Information Technology, I bring over 11.6 years of substantial experience in software development . My expertise revolves around Android and iOS app development, covering both Native and React Native mobile app development and also good exposure with backend API developement with sprintboot. Particularly noteworthy is my hands-on involvement in the IoT (Internet of Things) domain, where I've made significant contributions to prominent projects, including those for esteemed clients like McDonald's and the Joy the Wedding app.</h6>
